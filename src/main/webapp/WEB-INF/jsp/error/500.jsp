...
<head>
    ...
    <style type="text/css">
        ...
        body{font:14px/1.5 'Microsoft YaHei','微软雅黑',Helvetica,Sans-serif;min-width:1200px;background-image: url(../../../resources/images/404背景.jpg);}
        :focus{outline:0}
        h3,h4,strong{font-weight:700}
        a{color:#428bca;text-decoration:none}
        a:hover{text-decoration:underline}
        .error-page-container{position:relative;z-index:1;margin: 100px auto;opacity: 0.4}
...
<body >
    <div class="error-page-container" >
        <div class="error-page-main">
            <h3>
                <strong>500</strong>很抱歉，系统出现了错误！
            </h3>
            <div class="error-page-actions">
                <div>
                    <h4>可以尝试：</h4>
                    <ol>
                        <li><a href="/view/main">返回首页</a></li>
                        <li><a href="">留言反馈</a></li>
                        <li>
