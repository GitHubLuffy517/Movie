...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row" >
        ...
        <tr>
            <td>电影名称</td>
            <td>海报描述<i class="layui-icon layui-icon-edit"/></td>
            <td>操作</td>
        </tr>
        <c:forEach items="${posterList}" var="poster">
            <form action="/admin/updatePoster?PosterId=${poster.postId}" method="post">
                <tr>
                    <td><input class="layui-input" value="${poster.movieName}" readonly="readonly" ></td>
                    <td><input class="layui-input" value="${poster.postDescription}" name="PostDescription"></td>
                    <td>
                        <button class="layui-btn layui-btn-sm">更新</button>
                        <button class="layui-btn layui-btn-sm layui-btn-danger"><a
                                href="/admin/deletePoster?PosterId=${poster.postId}">删除</a></button>
                    </td>
                </tr>
            </form>
        </c:forEach>
